...
public struct Array_ : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static Array_ GetRootAsArray_(ByteBuffer _bb) { return GetRootAsArray_(_bb, new Array_()); }
  public static Array_ GetRootAsArray_(ByteBuffer _bb, Array_ obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Array_ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<global::ProtoCache.Tests.fb.Array_> CreateArray_(FlatBufferBuilder builder,
      VectorOffset _Offset = default(VectorOffset)) {
    builder.StartTable(1);
    Array_.Add_(builder, _Offset);
    return Array_.EndArray_(builder);
  }

  public static void StartArray_(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<global::ProtoCache.Tests.fb.Array_> EndArray_(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<global::ProtoCache.Tests.fb.Array_>(o);
  }
}


static public class Array_Verify
{
